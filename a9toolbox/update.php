        ...
        <body>
            <?php 
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $dbconnection = mysqli_connect(HOST, USER, PASSWORD, DB_NAME) or die('Connection failed.');
                    $query = "UPDATE a9musicians SET firstname='$firstname', lastname='$lastname', expertise='$expertise', phone='$phone', email='$email', about='$about', photo='$destination' WHERE id='$id'"; 
                    $result = mysqli_query($dbconnection, $query) or die('query failed.');
